...
def doctor(request):
	...
	if "Doctor" == group_name:
		...
		return render(request, 'doctor.html', appointments )
	else:
...
def doctor_appointment_list(request):
	...
	if "Doctor" == group_name:
		...
		return render(request, 'doctor_create_appointment.html', appointments )
	else:
		return redirect('http://127.0.0.1:8000/')
...
def doctor_appointment_update(request,id):
	...
	if "Doctor" == group_name:
		...
		return render(request, 'doctor_appointment_update.html', appointments )
	else:
		return redirect('http://127.0.0.1:8000/')